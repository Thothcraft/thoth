...
# E2 occupancy preprocessing lives in model_e2.py (torch-free, reusable by
# live-view feature extraction). Re-exported here for backwards compatibility.
try:
    from .model_e2 import (
        E2_WINDOW_FRAMES, E2_MAP_SIZE, E2_CSI_STEPS, E2_SUBCARRIERS,
        E2_RANGE_BINS, E2_AZ_BINS, E2_FRAME_PAYLOAD_BYTES,
        e2_radar_windows, e2_csi_windows,
    )
except ImportError:  # direct/script import (backend not a package on path)
    from model_e2 import (
        E2_WINDOW_FRAMES, E2_MAP_SIZE, E2_CSI_STEPS, E2_SUBCARRIERS,
        E2_RANGE_BINS, E2_AZ_BINS, E2_FRAME_PAYLOAD_BYTES,
        e2_radar_windows, e2_csi_windows,
